...
class TrainingModel:
    ...
    def __init__(self,learning_base,learning_name,games):
        self.learning_base=learning_base
        self.dataset_path="./bots/ml/datasets/"+learning_name+"_dataset.pkl"
        self.model_path=learning_name+"_model.pkl"
        self.games=games
        

    def create_dataset(self, phase=1):
        ...
        for g in range(self.games-1):

            # For progress bar
            if g % 10 == 0:
                percent = 100.0*g/self.games
                sys.stdout.write('\r')
            ...
            while not state.finished():
                ...
                move = self.learning_base.get_move(given_state)
        ...
        with open(self.dataset_path, 'wb') as output:
    ...
    def train_model(self):
        ...
        joblib.dump(model, "./bots/ml/models/" + self.model_path)
